...
class Tensor_Mini_Xception(Oracle):
    def __init__(self, modelPath, faceClassifierPath):
        ...
        #self.face_cascade = cv2.CascadeClassifier('C:\web_start\mlservice\team_server\code\VideoModule\haarcascade_files\haarcascade_frontalface_default.xml')
        #self.face_cascade = cv2.CascadeClassifier('C:\go\haarcascade_frontalface_default.xml')
        self.face_cascade = cv2.CascadeClassifier('C:\go\haarcascade_frontalface_default.xml')
        #self.face_cascade = cv2.CascadeClassifier('C:\Users\sts\Desktop\haarcascade_frontalface_default.xml')
    ...
    def just_drow(self, image, faces, predicted):
        ...
        for (fX,fY,fW,fH) in faces:
            ...
            #cv2.rectangle(image,(fX, fY),(fW, fH),(255,0,0),2)#dlib
            cv2.putText(image, label, (fX, fY + 10), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (0, 0, 255), 2)
            i+=1
